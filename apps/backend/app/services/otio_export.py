        ...
        if clip.subtitle_text:
            ...
            media_ref = otio.schema.GeneratorReference(
                ...
                metadata={
                    ...
                    "mrdv2_subtitle_style": {
                        "font_family": clip.subtitle_style.font_family if clip.subtitle_style else "sans-serif",
                        "font_size": clip.subtitle_style.font_size if clip.subtitle_style else 48,
                        "color": clip.subtitle_style.color if clip.subtitle_style else "#FFFFFF",
                    },
                },
            )
        elif clip.media_id:
